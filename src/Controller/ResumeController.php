...
class ResumeController extends AbstractController
{
    ...
    /**
     * @Route("/resume/reviewOld{id}", name="reviewOld_resume", requirements={"id"="\d+"})
     * @Method({"GET"})
     * @return array
     * @Template("resume/reviewOld.html.twig")
     */
    public function reviewOldResumeAction($id)
    {
        $resumes = $this->repo->findById($id);
        return ['resumes' => $resumes];
    ...
    public function searchResumeAction(Request $request, PaginatorInterface $paginator)
    {
        ...
        $userBuilder = $em->getRepository('App\Entity\User')->createQueryBuilder('us');
